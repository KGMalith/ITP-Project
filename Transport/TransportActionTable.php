...
<head>
    ...
    <title>Transport Action Table</title>
    <!--Custom CSS-->
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group btn-group-sm">
                                                            <a href="TransportAction.php?oid=<?php echo $omid  ?>"><button type="button" class="btn btn-secondary btn-sm" data-toggle="tooltip" data-placement="top" title="Action">
    ...
    <script>
        ...
        if (unknowntype) {
            swal.fire({
                ...
                title: 'Oops...',
                confirmButtonColor: 'green',
                text: 'Transport Action Not Found!',
                closeOnEsc: false,
                closeOnClickOutside: false,
            })
        }
