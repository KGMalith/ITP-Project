    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Vendors <span>Table</span></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="card mb-5">
            <div class="card-header">
              ...
              <div class="card-tools">
                <a href="AddVendorDetails.php"><button type="button" class="btn btn-success btn-sm">Add Vendor</button></a>
              </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <div class="btn-group btn-group-sm">
                              <a href="ViewVendorDetails.php?vendorid=<?php echo $VendorID  ?>"><button type="button" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="View">
                                  <i class="fas fa-eye"></i>
                                </button></a> &nbsp;&nbsp;
                              <a href="VendorDetails.php?vendorid=<?php echo $VendorID  ?>"><button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                                  <i class="fas fa-edit"></i>
                                </button></a> &nbsp;&nbsp;
                              <a href="../inc/DeleteVendor.php?vendorid=<?php echo $VendorID  ?>" class="btn-del"><button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Delete">
  ...
  <script>
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          swal.fire({
            icon: 'error',
            title: 'Cancelled',
            text: 'Vendor Detail is Not Deleted',
            confirmButtonColor: 'green',
    ...
    if (venupdate) {
      swal.fire({
        ...
        title: 'Success!',
        confirmButtonColor: 'green',
        text: 'Vendor Details are Updated Successfully.',
        closeOnEsc: false,
