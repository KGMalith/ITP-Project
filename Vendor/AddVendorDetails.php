    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Add Vendor Details</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                  ...
                  <form action="../inc/addvendor.php" method="POST">
                    ...
                    <div class="form-group ml-2">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" data-validation="length required" data-validation-length="4-60" data-validation-error-msg="Please Enter Minimum 4 & Maximum 60 Characters" name="vname">
                      </div>
                    </div>
                    ...
                    <div class="form-row ml-1">
                      ...
                      <div class="form-group col-md-3">
                        ...
                        <div class="input-group">
                          ...
                          if (isset($_GET['land'])) {
                            $land = $_GET['land'];
                            echo '<input type="text" class="form-control" data-validation-optional="true" data-validation="number length" data-validation-length="10-10" data-validation-error-msg="The Mobile Number Must Be 10 Digits" name="lnumber" value="' . $land . '">';
                          } else {
                            echo '<input type="text" class="form-control" data-validation-optional="true" data-validation="number length" data-validation-length="10-10" data-validation-error-msg="The Mobile Number Must Be 10 Digits" name="lnumber">';
                          }
                          ?>
                        </div>
                      </div>
                    ...
                    <div class="form-group ml-2">
                      ...
                      <div class="input-group">
                        ...
                        if (isset($_GET['address'])) {
                          ...
                          echo '<input type="text" class="form-control" data-validation="required" data-validation-error-msg="Please Fill the Address of vendor" name="address">';
                        }
                        ?>
                      </div>
                    </div>
                    <div class="form-row ml-1">
                      <div class="form-group col-md-6">
                        ...
                        <div class="input-group">
                          ...
                          if (isset($_GET['city'])) {
                            $city = $_GET['city'];
                            echo '<input type="text" class="form-control" data-validation="required" data-validation-error-msg="Please Fill the City of Vendor" name="city" value="' . $city . '">';
                          } else {
                            echo '<input type="text" class="form-control" data-validation="required custom" data-validation-regexp="^([a-zA-Z]+)$" data-validation-error-msg="Please Fill the City of Vendor" name="city">';
                          }
                          ?>
                        </div>
                      </div>
                      <div class="form-group col-md-4">
                        ...
                        <select id="customerDetailsvendorDistrict" name="District" class="form-control select2bs4" data-validation="required" data-validation-error-msg="Please Select District of vendor">
                          <?php include('../inc/districtList.php'); ?>
                        </select>
                      </div>
                    </div>
                    <button type="submit" id="addvendor" name="addVendor" class="btn btn-success">Add Vendor</button>
  ...
  <script>
    ...
    if (flashdata) {
      swal.fire({
        icon: 'success',
        title: 'Success!',
        text: 'Vendor Details are Submited Successfully.',
    ...
    vendorname = $('.taken').data('vendorname')
    if (vendorname) {
      swal.fire({
        icon: 'error',
        title: 'Oops...',
