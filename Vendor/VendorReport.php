          ...
          <div class="card mb-5">
            ...
            <div class="card-body">
              <ul class="nav nav-tabs mt-3 mb-5" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="../Customer/CustomerReport.php">Customer</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link active" href="VendorReport.php">Vendor</a>
                </li>
              </ul>
              <div style="overflow:auto;">
                <table id="example3" class="table table-bordered table-hover table-responsive-sm">
                  <thead>
                    <tr>
                      <th>Name</th>
