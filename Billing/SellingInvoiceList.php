...
$sql = "SELECT s.id, s.SInvoiveID,s.SellingInvDate,s.finalAmt,c.cName FROM sellinginvoicelist s,customer c WHERE s.CusID = c.customerID";
...
<head>
    ...
    <title>Selling Invoice List</title>
    <!--Custom CSS-->
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Selling Invoive List</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" id="cus">
                                    <h5 class="card-title">Selling Invoice List</h5>
                                    <div class="card-tools">
                                        <a href="sellRice.php"><button type="button" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="left" title="Print">Create</button></a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <table table id="example1" class="table table-bordered table-hover table-responsive-sm">
                                        ...
                                        <tbody>
                                            ...
                                            while ($result = mysqli_fetch_assoc($results)) {
                                                ...
                                                echo '
                              <tr>
                                <td>' . $result["SInvoiveID"] . '</td>
                                <td>' . $result["SellingInvDate"] . '</td>
                                <td>' . $result["cName"] . '</td>
                                <td>' . $result["finalAmt"] . '</td>
                                <td class="text-center">
                                <a href="sellinginvoice.php?&sellinvid=' . $result["id"] . '"><button type="button" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="PDF">
                                  <i class="fas fa-file-pdf"></i>
                                </button></a>
                                </td>
                                <td class="text-center">
                                <a href="../inc/deletesellinginvoice.php?id=' . $result["id"] . '" class="btn-del"><button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Delete">
                            ...
                            ';
                                            ?>
                                                <!-- <a href="buyinginvoiceList.php?id=' . $result[" id"] . '"><button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
    ...
    <script>
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    swal.fire({
                        icon: 'error',
                        title: 'Cancelled',
                        text: 'Selling Invoice Not Deleted',
                        confirmButtonColor: 'green',
        ...
        if (invoice) {
            swal.fire({
                ...
                title: 'Success!',
                confirmButtonColor: 'green',
                text: 'Selling Invoice Created Successfully.',
                closeOnEsc: false,
