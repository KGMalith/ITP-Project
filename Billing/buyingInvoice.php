        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link">BuyingInvoice</a>
                </li>
            </ul>
                        ...
                        <div class="col-12">
                            <div class="invoice p-3 mb-3">
                                ...
                                <div class="row no-print">
                                    <div class="col-12">
                                        <a href="buyinginvoiceprint.php?byninvid=<?php echo $byninvoicelistid ?>" target="_blank" class="btn btn-success float-right"><i class="fas fa-print"></i> Print</a>
