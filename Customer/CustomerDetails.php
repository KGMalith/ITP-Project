...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form action="../inc/updatecustomer.php" method="POST">
                    ...
                    <div class="form-group ml-2">
                      ...
                      <div class="input-group">
                        ...
                        if (isset($_GET['name'])) {
                          $name = $_GET['name'];
                          echo '<input type="text" class="form-control" data-validation=" length required" data-validation-length="min4" data-validation-error-msg="Please Enter Minimum 4 Characters" name="cname" value="' . $name . '">';
                        } else {
                          echo '<input type="text" class="form-control" data-validation=" length required" data-validation-length="min4" data-validation-error-msg="Please Enter Minimum 4 Characters" name="cname"  value="' . $customerName . '"; >';
                        }
                        ?>
                      ...
                      <div class="form-group col-md-3">
                        ...
                        <div class="input-group">
                          ...
                          if (isset($_GET['mobile'])) {
                            ...
                            echo '<input type="text" class="form-control"  data-validation="number length required" data-validation-length="10-10" data-validation-error-msg="The Mobile Number Must Be 10 Digits" name="mnumber"  value="' . $CustomerMNumber . '"; >';
                          }
                          ?>
                      ...
                      <div class="form-group col-md-3">
                        ...
                        <div class="input-group">
                          ...
                          if (isset($_GET['land'])) {
                            ...
                            echo '<input type="text" class="form-control" data-validation-optional="true" data-validation="number length" data-validation-length="10-10" data-validation-error-msg="The Land Number Must Be 10 Digits" name="lnumber" value="' . $CustomerLNumber . '">';
                          }
                          ?>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <div class="input-group">
                          ...
                          if (isset($_GET['email'])) {
                            ...
                            echo '<input type="email" class="form-control" data-validation-optional="true" data-validation="email" name="email" value="' . $CustomerEmail . '">';
                          }
                          ?>
                    ...
                    <div class="form-row ml-1">
                      <div class="form-group col-md-6">
                        ...
                        <div class="input-group">
                          ...
                          if (isset($_GET['city'])) {
                            ...
                            echo '<input type="text" class="form-control" data-validation="required custom" data-validation-regexp="^([a-zA-Z]+)$" data-validation-error-msg="Please Fill the City of Customer" name="city" value="' . $CustomerCity . '">';
                          }
                          ?>
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <select name="District" class="form-control select2bs4" data-validation="required" data-validation-error-msg="Please Select District of Customer">
                          <?php
                    ...
                    if (isset($_GET['cusid'])) {
                      ...
                      echo '<input type="hidden" name="customerid" value="' . $customer_id . '">';
                    }
                    ?>
  ...
  <script>
    ...
    const customername = $('.taken').data('customername')
    if (customername) {
      swal.fire({
        icon: 'error',
        title: 'Oops...',
