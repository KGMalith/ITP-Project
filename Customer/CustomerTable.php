    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Customers <span>Table</span></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="card mb-5">
            <div class="card-header">
              ...
              <div class="card-tools">
                <a href="AddCustomerDetails.php"><button type="button" class="btn btn-success btn-sm">Add Customer</button></a>
              </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              ...
              <div class="table-responsive">
                <div class="dataTables_wrapper container-fluid dt-bootstrap4">
                  <table id="example1" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        <th style="width: 12%">CustomerID</th>
                        <th>Full Name</th>
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <div class="btn-group btn-group-sm">
                              <a href="ViewCustomerDetails.php?customerid=<?php echo $CustomerID  ?>"><button type="button" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="View">
                                  <i class="fas fa-eye"></i>
                                </button></a> &nbsp;&nbsp;
                              <a href="CustomerDetails.php?customerid=<?php echo $CustomerID  ?>"><button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                                  <i class="fas fa-edit"></i>
                                </button></a> &nbsp;&nbsp;
                              <a href="../inc/deletecustomer.php?customerid=<?php echo $CustomerID  ?>" class="btn-del"><button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Delete">
