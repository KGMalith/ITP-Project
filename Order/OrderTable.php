...
$query = "SELECT o.OrderM_ID,o.Order_ID,c.cName,o.Order_Date,o.Order_D_Date,o.D_Status FROM orderm o, customer c WHERE o.customerID = c.customerID";
                    ...
                    <div class="card mb-5">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="AddOrder.php"><button type="button" class="btn btn-success btn-sm">Add Order</button></a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 15%">Expected Dilvery Date</th>
                                                <th>Customer Name</th>
                                                <th style="width: 10%">Dilivery</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group btn-group-sm">
                                                            <a href="ViewOrderdetails.php?oid=<?php echo $omid  ?>"><button type="button" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="View">
                                                                    <i class="fas fa-eye"></i>
                                                                </button></a> &nbsp;&nbsp;
                                                            <a href="OrdereDetails.php?oid=<?php echo $omid  ?>"><button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                    <i class="fas fa-edit"></i>
                                                                </button></a> &nbsp;&nbsp;
                                                            <a href="../inc/deleteOrder.php?oid=<?php echo $omid  ?>" class="btn-del"><button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Delete">
