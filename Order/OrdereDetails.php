...
if (isset($_GET['oid'])) {
    ...
    $sql = "SELECT o.Order_ID,o.customerID,o.Order_Date,o.Order_D_Date,o.D_Status,c.cName FROM orderm o,customer c WHERE o.customerID = c.customerID AND OrderM_ID='$ID'";
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="../inc/updateorder.php" method="POST">
                                        <div class="form-group col-md-3 ml-1">
                                            ...
                                            <div class="input-group">
                                                ...
                                                if (isset($_GET['orid'])) {
                                                    $orid = $_GET['orid'];
                                                    echo '<input type="text" class="form-control" name="orderid" value="' . $orid . '" readonly>';
                                                } else {
                                        ...
                                        <div class="form-row ml-1">
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <?php
                                                    if (isset($_GET['ordate'])) {
                                                        $ordate = $_GET['ordate'];
                                                        echo '<input type="text" name="orderdate" class="form-control" value="' . $ordate . '" readonly>';
                                                    } else {
                                                        echo ' <input type="text" name="orderdate" class="form-control" value="' . $date . '" readonly>';
                                                    }
                                            ...
                                            <div class="form-group col-md-3 ">
                                                ...
                                                <div class="input-group date" data-provide="datepicker">
                                                    ...
                                                    <?php
                                                    if (isset($_GET['delidate'])) {
                                                        $delidate = $_GET['delidate'];
                                                        echo '<input type="text" name="diliverydate" class="form-control" autocomplete="off" value="' . $delidate . '">';
                                                    } else {
                                                        echo '<input type="text" name="diliverydate" class="form-control" autocomplete="off" value="' . $ddate . '">';
                                                    }
                                        ...
                                        <div class="form-group col-md-4 ml-1">
                                            ...
                                            <select name="cusId" id="expensegroup" class="form-control">
                                                ...
                                                if (isset($_GET['cumid'])) {
                                                    ...
                                                    echo '<option selected value="' . $cusID . '">' . $cusName . '</option>';
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form-group clearfix">
                                                    <div class="icheck-primary d-inline">
                                                        <?php
                                                        if (isset($_GET['sts']) && $_GET['sts'] == 'Yes') {
                                                            echo '<input type="radio" id="radioPrimary1" name="check1" value="Yes" checked>';
                                                        } else {
                                                            if ($status == 'Yes') {
                                                                echo '
                                                    ...
                                                    <div class="icheck-primary d-inline ml-3">
                                                        ...
                                                        if (isset($_GET['sts']) && $_GET['sts'] == 'Yes') {
                                                            ...
                                                            if ($status == 'No') {
                                                                echo '
                                                               <input type="radio" id="radioPrimary2" name="check1" value="No" Checked>
                                                                ';
                                                            } else {
                                                                echo '
                                                    ...
                                                    <?php
                                                    if (isset($_GET['omid'])) {
                                                        echo '<input type="hidden" name="odermid" class="form-control" value="' . $_GET['omid'] . '">';
                                                    } else {
                                                        echo '<input type="hidden" name="odermid" class="form-control" value="' . $ID . '">';
                                                    }
                                                    ?>
                                        ...
                                        <button type="submit" id="updateorder" name="updateorder" class="btn btn-success">Update Order</button>
