...
$query = "SELECT v.VehID,v.VRegistrationNo,v.ModelNo,v.ChassisNo,v.EngineNo,v.VOwner,vt.V_typeName,e.name FROM employee e, vehicletype vt,vehicle v WHERE e.id = v.id AND vt.V_typeId = v.V_typeId";
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs mt-3 mb-5" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="../Reports/VehiclesReport.php">Vehicle</a>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_assoc($customers)) {
                                                ...
                                                $engine = $row['EngineNo'];
                                                $vehicle = $row['V_typeName'];
                                                $driver = $row['name'];
                                                $ownership = $row['VOwner'];
                                            ?>
