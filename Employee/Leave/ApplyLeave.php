                ...
                <div class="container-fluid">
                    <div class="card mb-5 col-12">
                        ...
                        <div class="card-body">
                            ...
                            <form action="../../inc/applyleave.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="leavetype">
                                                ...
                                                <?php
                                                $sql = "SELECT l.LeaveName,l.Lid FROM employee e, leavetype l WHERE l.EmpType = e.emptype AND e.id = '" . $EmpID . "'";
                                                $resultset = mysqli_query($con, $sql);
                                                while ($row = mysqli_fetch_assoc($resultset)) {
                                                    echo '
                                                            <option value="' . $row['Lid'] . '">' . $row['LeaveName'] . ' </option>
                                                        ';
                                                }
                                                ?>
                                    ...
                                    <div class="form-group col-md-3 ">
                                        <label>Leave Date<span class="requiredIcon" style="color:red;">*</span></label>
                                        <div class="input-group date" data-provide="datepicker">
                                            ...
                                            if (isset($_GET['date'])) {
                                                $joindate = $_GET['date'];
                                                echo '<input type="text" name="date" class="form-control" data-validation="required" data-validation-error-msg="Please Select Date" value="' . $joindate . '" autocomplete="off">';
                                            } else {
                                                echo '<input type="text" name="date" class="form-control" data-validation="required" data-validation-error-msg="Please Select Date" autocomplete="off">';
                                            }
                                            ?>
                                        </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <div class="input-group">
                                            ...
                                            if (isset($_GET['desc'])) {
                                                $desc = $_GET['desc'];
                                                echo '<input type="text" name="reason" id="reason" class="form-control" value="' . $desc . '">';
                                            } else {
                                                echo '<input type="text" name="reason" id="reason" class="form-control">';
                                            }
                                            ?>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    if (isset($_GET['id'])) {
                                        $empid = $_GET['id'];
                                        echo '<input type="hidden" name="employeeid" id="employeeid" class="form-control" value="' . $empid . '">';
                                    } else {
                                        echo '<input type="hidden" name="employeeid" id="employeeid" class="form-control" value="' . $EmpID . '">';
                                    }
                                    ?>
                                ...
                                <div class="form-group ml-1">
                                    <button type="submit" id="applyleave" name="applyleave" class="btn btn-success">Add Leave Type</button>
