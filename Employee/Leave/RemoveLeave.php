...
if (isset($_GET['empid'])) {
    ...
    $query = "SELECT e.empid,e.name, l.LeaveName,el.DaysTaken,el.days,el.LeaveID FROM empleave el,leavetype l, employee e WHERE e.id = el.empid AND el.Lid = l.Lid AND e.id='" . $EMP_ID . "'";
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Remove Leave</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-5">
                        <div class="card-header">
                            <h3 class="card-title">Remove Leave Details</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            ...
                            <?php if (isset($_GET['error']))
                                ...
                                <div class="cantdelete" data-deleteerror="<?= $_GET['cannotdelete']; ?>"></div>
                            <?php endif;  ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group btn-group-sm">
                                                            <a href="../../inc/deleteleave.php?eid=<?php echo $EMP_ID ?>&leaveid=<?php echo $leaveid ?>&days=<?php echo $days ?>" class="btn-del"><button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Delete">
    ...
    <script>
        ...
        deleteerror = $('.cantdelete').data('deleteerror')
        if (deleteerror) {
            swal.fire({
                icon: 'error',
                title: 'Oops...',
                confirmButtonColor: 'green',
                text: 'Leave Date is Past From Current Date',
                footer: 'Only Future Dates Can Be Deleted',
                closeOnEsc: false,
