...
if (isset($_GET['Lid'])) {
    $id = $_GET['Lid'];
    $query = "SELECT * FROM leavetype WHERE Lid='" . $id . "'";
    ...
    if ($resultset) {
        ...
        header("Location: LeaveTypeTable.php?error=SQLError");
        exit();
    }
}
                    ...
                    <div class="card mb-5 col-12">
                        ...
                        <div class="card-body">
                            ...
                            <form action="../../inc/updateleavetype.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            if (isset($_GET['levname'])) {
                                                ...
                                                echo '<input type="text" name="leavename" id="leavename" class="form-control" data-validation="required" data-validation-error-msg="Please Fill the Name " value="' . $lname . '">';
                                            }
                                            ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            if (isset($_GET['days'])) {
                                                ...
                                                echo '<input type="text" name="numdays" id="numdays" class="form-control" data-validation="required" data-validation-error-msg="Please Fill the Number Of Days" value="' . $noofdays . '">';
                                            }
                                            ?>
                                ...
                                <?php
                                if (isset($_GET['leavid'])) {
                                    $lvid = $_GET['leavid'];
                                    echo '<input type="hidden" name="leaveid" id="leaveid" class="form-control" value="' . $lvid . '">';
                                } else {
                                    echo '<input type="hidden" name="leaveid" id="leaveid" class="form-control" value="' . $id . '">';
                                }
                                ?>

                                <button type="submit" id="editleave" name="editleave" class="btn btn-success">Update Leave Type</button>
