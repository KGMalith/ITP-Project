                        ...
                        <div class="card-body">
                            ...
                            <form action="../inc/updatevehicle.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        if (isset($_GET['vehiid'])) {
                                            $vehicid = $_GET['vehiid'];
                                            echo '<input type="text" class="form-control" name="vehiID" value="' . $vehicid . '" readonly>';
                                        } else {
                                            echo '<input type="text" class="form-control" name="vehiID" value="' . $vehiid . '" readonly>';
                                        }
                                        ?>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            if (isset($_GET['regno'])) {
                                                ...
                                                echo '<input type="text" name="registerno" id="registerno" class="form-control" data-validation="required" data-validation-error-msg="Please Fill Vehicle Registration Number" value="' . $RegisterNo . '">';
                                            }
                                            ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            if (isset($_GET['modelNo'])) {
                                                ...
                                                echo '<input type="text" name="modelno" id="modelno" class="form-control" data-validation="required" data-validation-error-msg="Please Fill Vehicle Model Number" value="' . $ModelNo . '">';
                                            }
                                            ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            if (isset($_GET['casyNo'])) {
                                                ...
                                                echo '<input type="text" name="chasisno" id="chasisno" class="form-control" data-validation="required" data-validation-error-msg="Please Fill Vehicle Chassis Number" value="' . $ChassyNo . '">';
                                            }
                                            ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            if (isset($_GET['EngineNo'])) {
                                                $EngineNum = $_GET['EngineNo'];
                                                echo '<input type="text" name="engineno" class="form-control" data-validation="required" data-validation-error-msg="Please Fill Vehicle Engine Number" value="' . $EngineNum . '">';
                                            } else {
                                ...
                                if (isset($_GET['Vid'])) {
                                    $veID = $_GET['Vid'];
                                    echo '
                                                                <input type="hidden" name="Vehicleid" value="' . $veID . '">
                                                            ';
                                } else {
                                    echo '
                                ...
                                <div class="flex">
                                    <button type="submit" id="updatevehicle" name="updatevehicle" class="btn btn-success btn-md">Update Vehicle</button>
