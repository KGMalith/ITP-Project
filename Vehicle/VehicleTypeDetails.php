...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="../Vehicle/VehicleTypeTable.php" class="nav-link active">
                    ...
                    <div class="card mb-5 col-12">
                        ...
                        <div class="card-body">
                            ...
                            <?php if (isset($_GET['error']))
                                ...
                                <div class="taken" data-vehicletype="<?= $_GET['nametaken']; ?>"></div>
                            <?php endif;  ?>
                            ...
                            <form action="../inc/updatevehicletype.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            if (isset($_GET['typename'])) {
                                                ...
                                                echo '<input type="text" name="VTypename" id="VTypename" class="form-control" data-validation="required" data-validation-error-msg="Please Fill the Name " value="' . $typename . '">';
                                            } else {
                                                echo '<input type="text" name="VTypename" id="VTypename" class="form-control" data-validation="required" data-validation-error-msg="Please Fill the Name " value="' . $name . '">';
                                            }
                                            ?>
                                        </div>
                                    </div>
                                ...
                                <button type="submit" id="updatevtype" name="updatevtype" class="btn btn-success">Update Vehicle Type</button>
                                <a href="VehicleTypeTable.php"><button type="button" class="btn btn-warning ml-1" value="Back"><i class="fas fa-arrow-left"></i> Back To Table</button></a>
    ...
    <script>
        ...
        const vehicletype = $('.taken').data('vehicletype')
        if (vehicletype) {
            swal.fire({
                icon: 'error',
                title: 'Oops...',
                confirmButtonColor: 'green',
                text: 'Vehicle Type Name Already Taken!',
                closeOnEsc: false,
