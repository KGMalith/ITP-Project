...
<head>
    ...
    <title>Vehicle Type Table</title>
    <!--Custom CSS-->
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Vehicle Type <span>Table</span></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="card mb-5">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="AddVehicleType.php"><button type="button" class="btn btn-success btn-sm">Add Vehicle Type</button></a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group btn-group-sm">
                                                            ...
                                                            <a href="../inc/deletevehicletype.php?VTid=<?php echo $id  ?>" class="btn-del"><button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Delete">
