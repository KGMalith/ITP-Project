        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Vehicle <span>Table</span></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="card mb-5">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="AddVehicle.php"><button type="button" class="btn btn-success btn-sm">Add Vehicle</button></a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group btn-group-sm">
                                                            <a href="ViewVehicleDetails.php?vid=<?php echo $VehicleID  ?>"><button type="button" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="View">
                                                                    <i class="fas fa-eye"></i>
                                                                </button></a> &nbsp;&nbsp;
                                                            <a href="VehicleDetails.php?vid=<?php echo $VehicleID  ?>"><button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                    <i class="fas fa-edit"></i>
                                                                </button></a> &nbsp;&nbsp;
                                                            <a href="../inc/deletevehicle.php?vid=<?php echo $VehicleID  ?>" class="btn-del"><button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Delete">
