...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
                                    ...
                                    <div class="form-group col-4 ml-5">
                                        ...
                                        <div class="input-group">
                                            ...
                                            if (isset($_GET['typename'])) {
                                                ...
                                                echo '<input type="text" name="VTypename" id="VTypename" class="form-control" data-validation="required" data-validation-error-msg="Please Fill the Name ">';
                                            }
                                            ?>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        vehicletype = $('.taken').data('vehicletype')
        if (vehicletype) {
            swal.fire({
                icon: 'error',
                title: 'Oops...',
