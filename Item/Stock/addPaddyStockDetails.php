...
if (isset($_GET['stkid'])) {
    ...
    $sql = "SELECT p.p_ID,i.itemName,i.I_ID,p.initDate,p.quantity,p.Descrp FROM paddystock p, items i WHERE p.itemID = i.I_ID AND p.p_ID ={$stockid}";
    $result = mysqli_query($con, $sql);
    if ($result) {
        $row = mysqli_fetch_assoc($result);
        $itemid = $row['I_ID'];
        $itemName = $row['itemName'];
        $inidate = $row['initDate'];
...
<head>
    ...
    <title>Initialize Paddy Stock</title>
    <!--Custom CSS-->
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview ">
                                ...
                                <li class="nav-item">
                                    <a href="../../Item/Stock/addPaddyStockTable.php" class="nav-link active">
                                        <i class="nav-icon fas fa-boxes"></i>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title">Initialize Paddy Stock</h5>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="../../inc/updateaddpaddystock.php" method="POST">
                                        <div class="form-row ml-1">
                                            ...
                                            <div class="form-group">
                                                <label>Initializing Date<span class="requiredIcon" style="color:red;">*</span></label>
                                                <div class="input-group">
                                                    ...
                                                    <?php
                                                    if (isset($_GET['date'])) {
                                                        echo '<input type="text" name="initdate" class="form-control" value="' . $_GET['date'] . '" readonly>';
                                                    } else {
                                                        echo '<input type="text" name="initdate" class="form-control" value="' . $inidate . '" readonly>';
                                                    }
                                                    ?>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group ml-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <?php
                                                if (isset($_GET['descrp'])) {
                                                    echo '<input type="text" class="form-control" id="area" name="des" value="' . $_GET['descrp'] . '">';
                                                } else {
                                        ...
                                        if (isset($_GET['stockid'])) {
                                            echo '<input type="hidden" name="skID" value="' . $_GET['stockid'] . '"> ';
                                        } else {
                                            echo '<input type="hidden" name="skID" value="' . $stockid . '">';
                                        }

                                        ?>
                                        <br>
                                        <button type="submit" id="updatepaddystock" name="updatepaddystock" class="btn btn-success">Update Stock</button>
                                        <a href="addPaddyStockTable.php"><button type="button" class="btn btn-warning" value="Back"><i class="fas fa-arrow-left"></i> Back To Table</button></a>
                                    </form>
                                </div>
                            </div>
                        </div>
