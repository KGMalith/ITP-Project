                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="../../inc/addricestock.php" method="POST">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    if (isset($_GET['pri5'])) {
                                                        $price5 = $_GET['pri5'];
                                                        echo '<input type="text" class="form-control" name="quan5" id="small1" data-validation-optional="true" data-validation="number"  data-validation-error-msg="Please Enter Quantity" value="' . $price5 . '">';
                                                    } else {
                                                        echo '<input type="text" class="form-control" name="quan5" id="small1" data-validation-optional="true" data-validation="number"  data-validation-error-msg="Please Enter Quantity">';
                                                    }
                                                    ?>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    if (isset($_GET['pri10'])) {
                                                        $price10 = $_GET['pri10'];
                                                        echo '<input type="text" class="form-control" name="quan10" id="medium1" data-validation-optional="true" data-validation="number"  data-validation-error-msg="Please Enter Quantity" value="' . $price10 . '">';
                                                    } else {
                                                        echo '<input type="text" class="form-control" name="quan10" id="medium1" data-validation-optional="true" data-validation="number"  data-validation-error-msg="Please Enter Quantity">';
                                                    }
                                                    ?>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    if (isset($_GET['pri25'])) {
                                                        $price25 = $_GET['pri25'];
                                                        echo '<input type="text" class="form-control" name="quan25" id="large1" data-validation-optional="true" data-validation="number "  data-validation-error-msg="Please Enter Quantity" value="' . $price25 . '">';
                                                    } else {
                                                        echo '<input type="text" class="form-control" name="quan25" id="large1" data-validation-optional="true" data-validation="number "  data-validation-error-msg="Please Enter Quantity">';
                                                    }
                                                    ?>
                                        ...
                                        <br>
                                        <button type="submit" id="addriceStock" name="addriceStock" class="btn btn-success">Add Stock</button>
    ...
    <script>
        ...
        if (flashdata) {
            swal.fire({
                icon: 'success',
                title: 'Success!',
                text: 'Rice Stock Quantity Submited Successfully.',
