...
if (isset($_GET['itemid'])) {
    $rpid = mysqli_real_escape_string($con, $_GET['itemid']);
    $query = "SELECT r.item_ID,i.itemName,r.price5kg,r.price10kg,r.price25kg,r.Descrip FROM items i, riceprice r WHERE r.item_ID = i.I_ID AND r.rpID = {$rpid}";
    ...
    if ($resultset) {
        if (mysqli_num_rows($resultset) == 1) {
            ...
            $Price5kg = $result['price5kg'];
            $Price10kg = $result['price10kg'];
            $Price25kg = $result['price25kg'];
            $Desc = $result['Descrip'];
        } else {
            header('Location: RicePriceTable.php?ItemNotFound');
        }
    } else {
        header('Location: RicePriceTable.php?SQLError');
    }
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="../../inc/updatericeprice.php" method="POST">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control col-4" name="itemName" id="itemName1">
                                                ...
                                                ?>
                                                    <option value="<?php echo $Item_ID ?>" selected><?php echo $ItemName ?></option>
                                                    <?php echo $output; ?>
                                                <?php
                                                }
                                                ?>
                                        ...
                                        if (isset($_GET['iteID'])) {
                                            ...
                                            echo '<input type="hidden" name="itemid" value="' . $rpid . '">';
                                        }
                                        ?>
                                        <button type="submit" id="updateprice" name="updateprice" class="btn btn-success">Update Price</button>
