                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="../../inc/addconvertpaddystock.php" method="POST">
                                        <div class="form-row ml-1">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="input-group date" data-provide="datepicker">
                                                    ...
                                                    <input type="text" name="startdate" class="form-control" data-validation="required" data-validation-error-msg="Please Select Date" autocomplete="OFF">
                                        ...
                                        <br>
                                        <button type="submit" id="addpaddy" name="addpaddy" class="btn btn-success">Add Stock</button>
