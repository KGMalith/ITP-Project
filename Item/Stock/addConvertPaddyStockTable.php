...
$query = "SELECT i.itemName,c.cp_ID,c.startDate,c.endDate,c.quantity,c.convertStatus FROM convertpaddy c, items i WHERE c.itemID = i.I_ID";
...
<head>
    ...
    <title>Convert Paddy Table</title>
    <!--Custom CSS-->
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Convert Paddy</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-5">
                        <div class="card-header">
                            <h3 class="card-title">Convert Paddy Table</h3>
                            <div class="card-tools">
                                <a href="addConvertPaddyStock.php"><button type="button" class="btn btn-success btn-sm">Add Convert Paddy Stock</button></a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            ...
                            <?php if (isset($_GET['status']))
                                ...
                                <div class="successstatus" data-statusup="<?= $_GET['Success']; ?>"></div>
                            <?php endif;  ?>
                            ...
                            <?php if (isset($_GET['delete']))
                                if ($_GET['delete'] == "UnSuccess") : ?>
                                <div class="deleteerror" data-unsuccdelete="<?= $_GET['Success']; ?>"></div>
                            <?php endif;  ?>
                                    ...
                                    <table id="example1" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 15%">Expected Process Finish Date</th>
                                                <th>Quantity (KG)</th>
                                                <th style="width: 10%">Process Status</th>
                                                ...
                                                <tr>
                                                        ...
                                                        if ($convertstatus == 1) {
                                                            echo '
                                                                <div class="badge badge-success" role="alert"">
                                                                    <i class="fas fa-check-circle"></i>&nbsp; Converted To Rice
                                                                </div> 
                                                                ';
                                                        } else {
                                                            echo '
                                                                <div class="btn-group btn-group-sm">
                                                                    <a href="../../inc/Changedstatusconvertpaddy.php?cpid=' . $cpid . '"><button type="button" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Process Finished">
                                                                    <i class="fas fa-dolly"></i></button></a>
                                                                </div>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        if ($convertstatus == 1) {
                                                            echo '
                                                            <div class="btn-group btn-group-sm">
                                                                <a href="../../inc/Deleteconvertpaddy.php?cpid=' . $cpid . '" class="btn-del"><button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Delete">
                                                            ...
                                                            <div class="btn-group btn-group-sm">
                                                                <a href="addConvertPaddyStockDetails.php?cpid=' . $cpid . '"><button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
    ...
    <script>
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    swal.fire({
                        icon: 'error',
                        title: 'Cancelled',
                        text: 'Convert Paddy Detail is Not Deleted',
                        confirmButtonColor: 'green',
        ...
        statusup = $('.successstatus').data('statusup')
        if (statusup) {
            swal.fire({
                icon: 'success',
                title: 'Success!',
                text: 'Paddy Stock Converted Successfully.',
                confirmButtonColor: 'green',
                closeOnEsc: false,
        ...
        if (venupdate) {
            swal.fire({
                ...
                title: 'Success!',
                confirmButtonColor: 'green',
                text: 'Convert Paddy Stock Details are Updated Successfully.',
                closeOnEsc: false,
                closeOnClickOutside: false,
            })
        }
        ...
        unsuccdelete = $('.deleteerror').data('unsuccdelete')
        if (unsuccdelete) {
            swal.fire({
                icon: 'error',
                title: 'Oops...',
                confirmButtonColor: 'green',
                text: 'Convered Paddy Details Cannot Delete!',
                closeOnEsc: false,
                closeOnClickOutside: false,
            })
        }
