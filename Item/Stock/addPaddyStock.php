                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="../../inc/addpaddystock.php" method="POST">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="quantity" id="small1" data-validation="required" data-validation="number" data-validation-error-msg="Please Enter Quantity">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group ml-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="area" name="des">
                                            </div>
                                            <p>
                                        ...
                                        <br>
                                        <button type="submit" id="addpaddystock" name="addpaddystock" class="btn btn-success">Add Stock</button>
