...
$query = "SELECT r.rpID,i.itemName,r.price5kg,r.price10kg,r.price25kg,r.Descrip FROM items i, riceprice r WHERE r.item_ID = i.I_ID";
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Rice Price Table</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="card mb-5">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="RicePriceAdd.php"><button type="button" class="btn btn-success btn-sm">Add Rice Price</button></a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <?php if (isset($_GET['error']))
                                if ($_GET['error'] == "ItemNotFound") : ?>
                                <div class="noitem" data-unknownitem="<?= $_GET['ItemNotFound']; ?>"></div>
                            <?php endif;  ?>
                            ...
                            <?php if (isset($_GET['Update']))
                                ...
                                <div class="updateitem" data-itemupdate="<?= $_GET['Success']; ?>"></div>
                            <?php endif;  ?>
                                ...
                                <div class="dataTables_wrapper container-fluid dt-bootstrap4">
                                    <table id="example1" class="table table-bordered table-hover table-responsive-sm" overflow="auto">
                                        <thead>
                                            <tr>
                                                <th>Item Name</th>
                                                <th style="width: 14%">Unit Price(Rs) 5KG </th>
                                                <th style="width: 14%">Unit Price(Rs) 10KG</th>
                                                <th style="width: 14%">Unit Price(Rs) 25KG</th>
                                                <th>Description</th>
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_assoc($items)) {
                                                ...
                                                $Price10kg = $row['price10kg'];
                                                $Price25kg = $row['price25kg'];
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center fluid">
                                                        <a href="RicePriceDetails.php?itemid=<?php echo $Item_ID  ?>"><button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                <i class="fas fa-edit"></i>
                                                            </button></a>
                                                        <a href="../../inc/deletericeprice.php?itemid=<?php echo $Item_ID  ?>" class="btn-del"><button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Delete">
    ...
    <script>
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    swal.fire({
                        icon: 'error',
                        title: 'Cancelled',
                        text: 'Rice Price Detail is Not Deleted',
                        confirmButtonColor: 'green',
        ...
        itemupdate = $('.updateitem').data('itemupdate')
        if (itemupdate) {
            swal.fire({
                icon: 'success',
                title: 'Success!',
                confirmButtonColor: 'green',
                text: 'Rice Prices are Updated Successfully.',
                closeOnEsc: false,
        ...
        unknownitem = $('.noitem').data('unknownitem')
        if (unknownitem) {
            swal.fire({
                icon: 'error',
                title: 'Oops...',
