...
$query = "SELECT p.p_ID,i.itemName,p.initDate,p.quantity,p.Descrp FROM paddystock p, items i WHERE p.itemID = i.I_ID";
...
<head>
    ...
    <title>Paddy Stock Initialized Table</title>
    <!--Custom CSS-->
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Paddy Stock Initialized Table</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-5">
                        <div class="card-header">
                            <h3 class="card-title">Paddy Stock Initialized Table</h3>
                            <div class="card-tools">
                                <a href="addPaddyStock.php"><button type="button" class="btn btn-success btn-sm">Add Paddy Stock</button></a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center fluid">
                                                        <a href="addPaddyStockDetails.php?stkid=<?php echo $Item_ID  ?>"><button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                <i class="fas fa-edit"></i>
                                                            </button></a>
                                                        <a href="../../inc/deletepaddystock.php?stkid=<?php echo $Item_ID  ?>" class="btn-del"><button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Delete">
    ...
    <script>
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    swal.fire({
                        icon: 'error',
                        title: 'Cancelled',
                        text: 'Paddy Stock Detail is Not Deleted',
                        confirmButtonColor: 'green',
        ...
        if (itemupdate) {
            swal.fire({
                ...
                title: 'Success!',
                confirmButtonColor: 'green',
                text: 'Paddy Stock Details are Updated Successfully.',
                closeOnEsc: false,
