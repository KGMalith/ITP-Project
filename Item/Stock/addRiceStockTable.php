        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Rice Stock Table</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="card mb-5">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="addRiceStock.php"><button type="button" class="btn btn-success btn-sm">Add Rice Stock</button></a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center fluid">
                                                        <a href="addRiceStockDetails.php?stockid=<?php echo $Item_ID  ?>"><button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                <i class="fas fa-edit"></i>
                                                            </button></a>&nbsp;&nbsp;
                                                        <a href="../../inc/deletericestock.php?stockid=<?php echo $Item_ID  ?>" class="btn-del"><button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Delete">
    ...
    <script>
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    swal.fire({
                        icon: 'error',
                        title: 'Cancelled',
                        text: 'Rice Quantity Detail is Not Deleted',
                        confirmButtonColor: 'green',
        ...
        if (itemupdate) {
            swal.fire({
                ...
                title: 'Success!',
                confirmButtonColor: 'green',
                text: 'Rice Quantity are Updated Successfully.',
                closeOnEsc: false,
