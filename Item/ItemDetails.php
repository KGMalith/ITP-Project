                                    ...
                                    <form action="../inc/updateitem.php" method="POST">
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                if (isset($_GET['itemid'])) {
                                                    $item_id = $_GET['itemid'];
                                                    echo '<input type="text" class="form-control" name="itemidgen" value="' . $item_id . '" readonly>';
                                                } else {
                                                    echo '<input type="text" class="form-control" name="itemidgen" value="' . $itemidgenerated . '" readonly>';
                                                }
                                                ?>
                                            </div>
                                        </div>
