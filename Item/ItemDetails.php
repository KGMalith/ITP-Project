...
if (isset($_GET['itemid'])) {
  ...
  if ($resultset) {
    if (mysqli_num_rows($resultset) == 1) {
      ...
      $Quan5kg = $result['5KGQuantity'];
      $Price5kg = $result['5KGPrice'];
      $Quan10kg = $result['10KGQuantity'];
      $Price10kg = $result['10KGPrice'];
      $Quan25kg = $result['25KGQuantity'];
      $Price25kg = $result['25KGPrice'];
      $Desc = $result['description'];
    } else {
      header('Location: ItemTable.php?ItemNotFound');
    }
  } else {
    header('Location: ItemTable.php?SQLError');
  }
}
                  ...
                  <form action="../inc/additem.php" method="POST">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        if (isset($_GET['name'])) {
                          $itname = $_GET['name'];
                          echo '<input type="text" class="form-control" data-validation="required"  data-validation-error-msg="Please Enter Item Name" name="iname" value="' . $itname . '">';
                        } else {
                          echo '<input type="text" class="form-control" data-validation="required"  data-validation-error-msg="Please Enter Item Name" name="iname" value="' . $ItemName . '">';
                        }
                        ?>
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-3">
                        ...
                        <div class="input-group">
                          ...
                          if (isset($_GET['qun5'])) {
                            $quantity5 = $_GET['qun5'];
                            echo '<input type="text" class="form-control" name="qun5" id="small" data-validation-optional="true" data-validation="number " data-validation-error-msg="Please Enter Quantity" value="' . $quantity5 . '">';
                          } else {
                            echo '<input type="text" class="form-control" name="qun5" id="small" data-validation-optional="true" data-validation="number " data-validation-error-msg="Please Enter Quantity" value="' . $Quan5kg . '">';
                          }
                          ?>
                        </div>
                      </div>
                      <div class="form-group col-md-3">
                        ...
                        <div class="input-group">
                          ...
                          if (isset($_GET['pri5'])) {
                            $price5 = $_GET['pri5'];
                            echo '<input type="text" class="form-control" name="pri5" id="small1" data-validation-optional="true" data-validation="number" data-validation-allowing="float"  data-validation-error-msg="Please Enter Price" value="' . $price5 . '">';
                          } else {
                            echo '<input type="text" class="form-control" name="pri5" id="small1" data-validation-optional="true" data-validation="number" data-validation-allowing="float"  data-validation-error-msg="Please Enter Price" value="' . $Price5kg . '">';
                          }
                          ?>
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-3">
                        ...
                        <div class="input-group">
                          ...
                          if (isset($_GET['qun10'])) {
                            ...
                            echo '<input type="text" class="form-control" name="qun10" id="medium" data-validation-optional="true" data-validation="number" data-validation-error-msg="Please Enter Quantity" value="' . $quantity10 . '">';
                          } else {
                            echo '<input type="text" class="form-control" name="qun10" id="medium" data-validation-optional="true" data-validation="number" data-validation-error-msg="Please Enter Quantity" value="' . $Quan10kg . '">';
                          }
                          ?>
                      ...
                      <div class="form-group col-md-3">
                        ...
                        <div class="input-group">
                          ...
                          if (isset($_GET['pri10'])) {
                            $price10 = $_GET['pri10'];
                            echo '<input type="text" class="form-control" name="pri10" id="medium1" data-validation-optional="true" data-validation="number" data-validation-allowing="float"  data-validation-error-msg="Please Enter Price" value="' . $price10 . '">';
                          } else {
                            echo '<input type="text" class="form-control" name="pri10" id="medium1" data-validation-optional="true" data-validation="number" data-validation-allowing="float"  data-validation-error-msg="Please Enter Price" value="' . $Price10kg . '">';
                          }
                          ?>
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-3">
                        ...
                        <div class="input-group">
                          ...
                          if (isset($_GET['qun25'])) {
                            ...
                            echo '<input type="text" class="form-control" name="qun25" id="large" data-validation-optional="true" data-validation="number" data-validation-error-msg="Please Enter Quantity" value="' . $quantity25 . '">';
                          } else {
                            echo '<input type="text" class="form-control" name="qun25" id="large" data-validation-optional="true" data-validation="number" data-validation-error-msg="Please Enter Quantity" value="' . $Quan25kg . '">';
                          }
                          ?>
                      ...
                      <div class="form-group col-md-3">
                        ...
                        <div class="input-group">
                          ...
                          if (isset($_GET['pri25'])) {
                            $price25 = $_GET['pri25'];
                            echo '<input type="text" class="form-control" name="pri25" id="large1" data-validation-optional="true" data-validation="number " data-validation-allowing="float"  data-validation-error-msg="Please Enter Price" value="' . $price25 . '">';
                          } else {
                            echo '<input type="text" class="form-control" name="pri25" id="large1" data-validation-optional="true" data-validation="number " data-validation-allowing="float"  data-validation-error-msg="Please Enter Price" value="' . $Price25kg . '">';
                          }
                          ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        if (isset($_GET['des'])) {
                          ...
                          echo '<input type="text" class="form-control" id="area" name="des" value="' . $Desc . '">';
                        }
                        ?>
                    ...
                    if (isset($_GET['iteID'])) {
                      $iteID = $_GET['iteID'];
                      echo '<input type="hidden" name="itemid" value="' . $iteID . '">';
                    } else {
                      echo '<input type="hidden" name="itemid" value="' . $Item_ID . '">';
                    }
                    ?>
                    <button type="submit" id="addCustomer" name="addItem" class="btn btn-success">Update Item</button>
