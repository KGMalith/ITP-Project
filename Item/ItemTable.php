    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Item Table</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="card mb-5">
            <div class="card-header">
              ...
              <div class="card-tools">
                <a href="AddItem.php"><button type="button" class="btn btn-success btn-sm">Add Item</button></a>
              </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <div class="dataTables_wrapper container-fluid dt-bootstrap4">
                  <table id="example1" class="table table-bordered table-hover table-responsive-sm" overflow="auto">
                    <thead>
                      <tr>
                        <th>Item Name</th>
                        <th style="width: 10%">Stock (Units) 5KG</th>
                        <th style="width: 10%">Unit Price(Rs) 5KG </th>
                        <th style="width: 10%">Stock (Units) 10KG</th>
                        <th style="width: 10%">Unit Price(Rs) 10KG</th>
                        <th style="width: 10%">Stock (Units) 25KG</th>
                        <th style="width: 10%">Unit Price(Rs) 25KG</th>
                      ...
                      ?>
                        ...
                        <tr>
                          ...
                          <td class="text-center fluid">
                            <a href="ViewItemDetails.php?itemid=<?php echo $Item_ID  ?>"><button type="button" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="View">
                                <i class="fas fa-file-alt"></i>
                              </button></a>
                            <a href="ItemDetails.php?itemid=<?php echo $Item_ID  ?>"><button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                                <i class="fas fa-edit"></i>
                              </button></a>
                            <a href="../inc/deleteitem.php?itemid=<?php echo $Item_ID  ?>" class="btn-del"><button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Delete">
