...
$query = "SELECT expensetype.ExpTName,expensegroup.ExpGName,expense.Date,expense.Amount,expense.PMethod,expense.EXPID FROM expense,expensetype,expensegroup WHERE expense.ExpGID = expensegroup.ExpGID AND expense.ExpTID = expensetype.ExpTID";
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group btn-group-sm">
                                                            <a href="ViewExpense.php?EXid=<?php echo $id  ?>"><button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                    <i class="fas fa-edit"></i>
                                                                </button></a> &nbsp;&nbsp;
                                                            <a href="../inc/deleteexpense.php?EXid=<?php echo $id  ?>" class="btn-del"><button type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Delete">
    ...
    <script>
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    swal.fire({
                        icon: 'error',
                        title: 'Cancelled',
                        text: 'Expense Detail is Not Deleted',
                        confirmButtonColor: 'green',
        ...
        if (venupdate) {
            swal.fire({
                ...
                title: 'Success!',
                confirmButtonColor: 'green',
                text: 'Expense Details are Updated Successfully.',
                closeOnEsc: false,
