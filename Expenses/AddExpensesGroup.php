<?php
include '../inc/expensesgroupid.php';
SESSION_START();
              ...
              <form action="../inc/addexpensegroup.php" method="POST">
                ...
                <div class="form-group col-md-3">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="expgrupid" value="<?php echo $expgroupid ?>" readonly>
                  </div>
                </div>
                ...
                <div class="form-group col-4">
                  ...
                  <div class="input-group">
                    ...
                    if (isset($_GET['egroup'])) {
                      ...
                      echo '<input type="text" name="expensegroupname" id="expensegroupname" class="form-control" data-validation="required" data-validation-error-msg="Please Fill the Name ">';
                    }
                    ?>
                  </div>
                </div>
                ...
                <div class="form-group ml-2">
                  ...
                  <div class="input-group">
                    ...
                    if (isset($_GET['desc'])) {
                      ...
                      echo '<input type="text" class="form-control" id="area" name="description">';
                    }
                    ?>
