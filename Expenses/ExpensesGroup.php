...
if (isset($_GET['Gid'])) {
    ...
    $sql = "SELECT * FROM expensegroup WHERE ExpGID=$GID";
    ...
    if ($result) {
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            header("Location:ExpensesGroupTable.php?error=nogroup");
            exit();
        }
    } else {
        header("Location:ExpensesGroupTable.php?error=SQLError");
        exit();
    }
}
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="../Expenses/ExpensesGroupTable.php" class="nav-link active">
                                        <i class="nav-icon fas fa-dollar-sign"></i>
                                        <p>Expense Group</p>
                                    </a>
                                </li>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Expense Group</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    <div class="card mb-5 col-12">
                        ...
                        <div class="card-header" id="cus">
                            <h5 class="card-title">Add Expense Group</h5>
                        ...
                        <div class="card-body">
                            ...
                            <?php if (isset($_GET['error']))
                                ...
                                <div class="taken" data-groupname="<?= $_GET['nametaken']; ?>"></div>
                            <?php endif;  ?>
                            ...
                            <form action="../inc/updateexpensesgroup.php" method="POST">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        if (isset($_GET['egroup'])) {
                                            $Egroup = $_GET['egroup'];
                                            echo '<input type="text" name="expensegroupname" id="expensegroupname" class="form-control" data-validation="required" data-validation-error-msg="Please Fill the Name " value="' . $Egroup . '">';
                                        } else {
                                            echo '<input type="text" name="expensegroupname" id="expensegroupname" class="form-control" data-validation="required" data-validation-error-msg="Please Fill the Name " value="' . $groupname . '">';
                                        }
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ml-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        if (isset($_GET['desc'])) {
                                            $desc = $_GET['desc'];
                                            echo '<input type="text" class="form-control" id="area" name="description" value="' . $desc . '">';
                                        } else {
                                            echo '<input type="text" class="form-control" id="area" name="description" value="' . $groupdesc . '">';
                                        }
                                        ?>
                                ...
                                if (isset($_GET['id'])) {
                                    $ID = $_GET['id'];
                                    echo '<input type="hidden" id="groupid" name="groupid" value="' . $ID . '">';
                                } else {
                                    echo '<input type="hidden" id="groupid" name="groupid" value="' . $GID . '">';
                                }
                                ?>
                                <div class="form-group flex ml-2">
                                    <button type="submit" id="updategroup" name="updategroup" class="btn btn-success">Update Group Name</button>
    ...
    <script>
        ...
        if (flashdata) {
            swal.fire({
                icon: 'success',
                title: 'Success!',
                text: 'Expense Group Submited Successfully.',
        ...
        groupname = $('.taken').data('groupname')
        if (groupname) {
            swal.fire({
                icon: 'error',
                title: 'Oops...',
                confirmButtonColor: 'green',
                text: 'Expense Group Name Already Taken!',
                closeOnEsc: false,
                closeOnClickOutside: false,
            })
        }
