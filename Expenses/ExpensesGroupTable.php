...
$query = "SELECT * FROM expensegroup";
$expgroup = mysqli_query($con, $query);
...
<head>
    ...
    <title>Expense Group Table</title>
    <!--Custom CSS-->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-5">
                        <div class="card-header">
                            <h3 class="card-title">Expense Group Table</h3>
                            <div class="card-tools">
                                <a href="AddExpensesGroup.php"><button type="button" class="btn btn-success btn-sm">Add Expense Group</button></a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <?php if (isset($_GET['error']))
                                if ($_GET['error'] == "nogroup") : ?>
                                <div class="nogroup" data-unknowngroup="<?= $_GET['nogroup']; ?>"></div>
                            <?php endif;  ?>
    ...
    <script>
        ...
        if (venupdate) {
            swal.fire({
                ...
                title: 'Success!',
                confirmButtonColor: 'green',
                text: 'Expense Group Details are Updated Successfully.',
                closeOnEsc: false,
        ...
        unknowngroup = $('.nogroup').data('unknowngroup')
        if (unknowngroup) {
            swal.fire({
                icon: 'error',
                title: 'Oops...',
                confirmButtonColor: 'green',
                text: 'Expense Group Not Found!',
                closeOnEsc: false,
                closeOnClickOutside: false,
            })
        }
