...
<head>
  ...
  <title>Add Expenses Types</title>
  <!--Custom CSS-->
        ...
        <div class="container-fluid">
          <div class="card mb-5 col-12">
            ...
            <div class="card-header" id="cus">
              <h5 class="card-title">Add Expenses Types</h5>
            ...
            <div class="card-body">
              ...
              <form action="../inc/addexpensestype.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group col-5 ml-5">
                    ...
                    <div class="input-group">
                      ...
                      if (isset($_GET['exname'])) {
                        ...
                        echo '<input type="text" name="expensename" id="expensename" class="form-control" data-validation="required" data-validation-error-msg="Please Fill the Name">';
                      }
                      ?>
